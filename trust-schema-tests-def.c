...
trust_schema_test_t trust_schema_tests[TRUST_SCHEMA_NUM_TESTS] = {
    {
      ...
      strlen(test_rule_0_data_pattern_string),
      test_rule_0_key_pattern_string,
      strlen(test_rule_0_key_pattern_string),
      &test_data_name_0,
      test_data_name_0_string,
      strlen(test_data_name_0_string),
      &test_key_name_0,
      test_key_name_0_string,
      strlen(test_key_name_0_string),
    ...
    },
    {
      ...
      strlen(test_rule_15_data_pattern_string),
      test_rule_15_key_pattern_string,
      strlen(test_rule_15_key_pattern_string),
      &test_data_name_15,
      test_data_name_15_string,
      strlen(test_data_name_15_string),
      &test_key_name_15,
      test_key_name_15_string,
      strlen(test_key_name_15_string),
    ...
    },
    {
      ...
      strlen(test_rule_16_data_pattern_string),
      test_rule_16_key_pattern_string,
      strlen(test_rule_16_key_pattern_string),
      &test_data_name_16,
      test_data_name_16_string,
      strlen(test_data_name_16_string),
      &test_key_name_16,
      test_key_name_16_string,
      strlen(test_key_name_16_string),
    ...
    },
    {
      ...
      strlen(test_rule_17_data_pattern_string),
      test_rule_17_key_pattern_string,
      strlen(test_rule_17_key_pattern_string),
      &test_data_name_17,
      test_data_name_17_string,
      strlen(test_data_name_17_string),
      &test_key_name_17,
      test_key_name_17_string,
      strlen(test_key_name_17_string),
    ...
    },
    {
      ...
      strlen(test_rule_20_data_pattern_string),
      test_rule_20_key_pattern_string,
      strlen(test_rule_20_key_pattern_string),
      &test_data_name_20,
      test_data_name_20_string,
      strlen(test_data_name_20_string),
      &test_key_name_20,
      test_key_name_20_string,
      strlen(test_key_name_20_string),
